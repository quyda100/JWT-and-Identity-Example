...
namespace auth.Services
{
    public class StatisticService : IStatisticService
    {
        ...
        public long OrderSalesTotalMonth(int month)
        {
            ...
            long total = orders.Where(o => o.PaymentTime != DateTime.MinValue).Sum(o => o.Total);
            return total;
        }
        ...
        public List<object> BrandCountSales(int month)
        {
            ...
            var orders = _context.Orders.Where(o => o.PaymentTime != DateTime.MinValue && o.CreatedAt.Month == month && o.CreatedAt.Year == DateTime.Now.Year).Include(o => o.OrderProducts).ThenInclude(p => p.Product).ToList();
